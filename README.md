This project is a simple network monitoring tool built in Python. It checks if devices are reachable using ping and records their latency and status (UP or DOWN) in a database.
